 ...
 * Works with jQuery +1.2.6. Tested on FF 2/3, IE 6/7/8, Opera 9.5/6, Safari 3,
 * Chrome 1 on WinXP.
 *
 ...
 * @param {String, Number, DOMElement, jQuery, Object} target Where to scroll the
 * matched elements.
 ...
 * 'li:eq(2)', etc )
 *		- A hash { top:x, left:y }, x and y can be any kind of number/string like
 * above.
 *		- A percentage of the container's dimension/s, for example: 50% to go to the
 * middle.
 *		- The string 'max' for go-to-end.
 * @param {Number} duration The OVERALL length of the animation, this argument
 * can be the settings object instead.
 * @param {Object,Function} settings Optional set of settings or the onAfter
 * callback.
...
;( function( $ )
{
  ...
  // Hack, hack, hack :)
  // Returns the real elements to scroll (supports window/iframes, documents and
  // regular nodes)
